...
Python pandas library is largely used for the Data Transformation process as it is very easy to use and the functions are simple and has very good readibility. I could have used the builtin csv library for speed, but using pandas keeps this script easy to adapt if we were to include other file extension like excel, json, etc.
...
There is some assumption I made to simplify the process:
	...
	- Regions are not intepreted or mapped to canonical regions. e.g. Klang Valley or KL are not mapped to Central
